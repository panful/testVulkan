...
private:
    ...
    {
        // 
        CreateGraphicsPipeline(m_graphicsPipelines.at(0), VK_PRIMITIVE_TOPOLOGY_TRIANGLE_LIST, VK_POLYGON_MODE_FILL, 0);
        // 
        CreateGraphicsPipeline(m_graphicsPipelines.at(1), VK_PRIMITIVE_TOPOLOGY_TRIANGLE_LIST, VK_POLYGON_MODE_FILL, 1);
        // 
        CreateGraphicsPipeline(m_graphicsPipelines.at(2), VK_PRIMITIVE_TOPOLOGY_TRIANGLE_LIST, VK_POLYGON_MODE_FILL, 2);
    }
    ...
    void CreateGraphicsPipeline(VkPipeline& pipeline, VkPrimitiveTopology topo, VkPolygonMode mode, uint32_t constant_id)
    {
        ...
        specializationData.color_mode = constant_id;

        VkSpecializationMapEntry specializationMapEntry = {};
        specializationMapEntry.constantID               = 0; // constant_id = 0
        specializationMapEntry.offset                   = 0;
        specializationMapEntry.size                     = sizeof(SpecializationData);
        ...
        fragShaderStageInfo.pSpecializationInfo             = &specializationInfo; // 着色器中的 constant_id
