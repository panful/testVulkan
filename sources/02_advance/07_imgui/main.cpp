...
private:
    ...
    void PrepareImGui()
    {
        ...
        ImGui::Begin("Window 1");
        {
            ...
            std::vector<char> inputText(100);
            if (ImGui::InputText("test_label", inputText.data(), inputText.size()))
            {
                std::cout << "InputText\n";
            }
        }
    ...
    {
        auto vertShaderCode = ReadFile("../resources/shaders/02_07_base_vert.spv");
        auto fragShaderCode = ReadFile("../resources/shaders/02_07_base_frag.spv");
