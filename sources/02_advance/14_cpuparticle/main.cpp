...
private:
    ...
    {
        auto vertShaderCode = ReadFile("../resources/shaders/02_14_base_vert.spv");
        auto fragShaderCode = ReadFile("../resources/shaders/02_14_base_frag.spv");
