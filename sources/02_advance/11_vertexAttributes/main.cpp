...
private:
    ...
    void PrepareImGui()
    {
        ...
        ImGui::Begin("Vertex Attribute Type");
        {
            ImGui::RadioButton("Interleaved", &m_attributeType, 0);
            ImGui::SameLine();
            ImGui::RadioButton("Separate", &m_attributeType, 1);
        }
        ImGui::End();
    ...
    {
        auto vertShaderCode = ReadFile("../resources/shaders/02_11_base_vert.spv");
        auto fragShaderCode = ReadFile("../resources/shaders/02_11_base_frag.spv");
