...
const std::vector<Vertex> vertices  {
    {{-0.8f, -0.1f}, {1.f, 1.f, 1.f}},
    {{-0.8f,  0.1f}, {1.f, 1.f, 1.f}},
    {{-0.6f,  0.1f}, {1.f, 1.f, 1.f}},
    {{-0.6f, -0.1f}, {1.f, 1.f, 1.f}},
};
...
private:
    ...
    {
        auto vertShaderCode = ReadFile("../resources/shaders/02_19_base_vert.spv");
        auto fragShaderCode = ReadFile("../resources/shaders/02_19_base_frag.spv");
