...
)
{
    ...
    vk::PipelineDepthStencilStateCreateInfo pipelineDepthStencilStateCreateInfo(
        {}, depthBuffered, depthBuffered, vk::CompareOp::eLessOrEqual, false, false, {}, {}
    );
...
int main()
{
    try
    {
        ...
        DepthBufferData depthImagedata(physicalDevice, device, depthFormat, extent);
        ...
        vk::SubpassDescription subpassDescription({}, vk::PipelineBindPoint::eGraphics, {}, colorAttachments, {}, &depthAttachment, {});
        ...
        std::array<vk::DescriptorSetLayout, MaxFramesInFlight> descriptorSetLayouts {descriptorSetLayout, descriptorSetLayout, descriptorSetLayout};
        ...
        //--------------------------------------------------------------------------------------
        std::array<std::array<vk::ImageView, 2>, MaxFramesInFlight> imageViews {
            std::array<vk::ImageView, 2> {colorImageDatas[0].imageView, depthImagedata.imageView},
            std::array<vk::ImageView, 2> {colorImageDatas[1].imageView, depthImagedata.imageView},
            std::array<vk::ImageView, 2> {colorImageDatas[2].imageView, depthImagedata.imageView},
        };
        ...
        while (count++ < 9)
        {
            ...
            defaultUBO.view  = glm::lookAt(glm::vec3(0.f, 0.f, -2.f), glm::vec3(0.f), glm::vec3(0.f, 1.f, 0.f));
            defaultUBO.proj  = glm::perspective(glm::radians(45.f), 8 / 6.f, 0.1f, 100.f);
            defaultUBO.proj[1][1] *= -1;
