...
int main()
{
    try
    {
        ...
        std::array<std::array<vk::WriteDescriptorSet, 1>, MaxFramesInFlight> writeDescriptorSets {
            std::array {vk::WriteDescriptorSet {descriptorSets[0], 0, 0, vk::DescriptorType::eUniformBuffer, nullptr, descriptorBufferInfo0}},
            std::array {vk::WriteDescriptorSet {descriptorSets[1], 0, 0, vk::DescriptorType::eUniformBuffer, nullptr, descriptorBufferInfo1}},
            std::array {vk::WriteDescriptorSet {descriptorSets[2], 0, 0, vk::DescriptorType::eUniformBuffer, nullptr, descriptorBufferInfo2}},
        };
