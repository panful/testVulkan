...
private:
    ...
    void BuildCommandBuffers()
    {
        for (auto i = 0u; i < MAX_FRAMES_IN_FLIGHT; ++i)
        {
            ...
            RecordCommandBuffer(m_commandBuffers[i], m_swapChainFramebuffers[i], m_descriptorSets[i]);
        }
    }
...
private:
    ...
    void CreateSwapChain()
    {
        ...
        {
            throw std::runtime_error("Max frames in flight is not equal to swap chain iamges");
        }
    ...
    {
        auto vertShaderCode = ReadFile("../resources/shaders/01_10_base_vert.spv");
        auto fragShaderCode = ReadFile("../resources/shaders/01_10_base_frag.spv");
    ...
    /// @brief 记录指令到指令缓冲
    void RecordCommandBuffer(const VkCommandBuffer commandBuffer, const VkFramebuffer framebuffer, const VkDescriptorSet descriptorSet) const
    {
